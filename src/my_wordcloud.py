...
# 词云图片
WC_IMG = 'data/wawa1.jpg'
# 词云字体
WC_FONT_PATH = r'C:\Windows\Fonts\simsun.ttc'


def get_word_list(comment_path):
    wordlist = None
...
def cut_word(comment_path):
    wordlist = get_word_list(comment_path)
    new_word_list = []
...
def create_word_cloud(comment_path=None):
    ...
    # 生成词云
    word_cloud = wc.generate(cut_word(comment_path))
...
if __name__ == '__main__':
    print('hello')
    create_word_cloud('D:\ACM_Code_Lib\other\爬虫\jd_comment.txt')